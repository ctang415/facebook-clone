        ...
        return (
            <div className="w-[75vw] mx-[10vw] pt-[6vh] grid grid-cols-2">
                <div className="flex flex-col gap-8">
                    ...
                    <form onSubmit={updatedInformation} className={ editInformation === true ? "p-4 max-w-[30vw] bg-white rounded shadow-md flex flex-col gap-2" : "hidden"}>
                        <input className="p-2 border-2 rounded border-grey" type="text" name="location" placeholder="Location" onChange={(e) => setLocation(e.target.value)}></input>
                        <input className="p-2 border-2 rounded border-grey" type="text" name="school" placeholder="School" onChange={(e) => setSchool(e.target.value)}></input>
