    ...
    return (
        ...
        <div className='relative'>
            ...
            flex flex-col min-w-[42.5vw] max-w-[42.5vw] rounded border-2 border-slate-50 shadow-xl bg-white'>
                ...
                <div className='flex flex-row justify-around border-y-2 p-2'>
                    <div onClick={ post.likes.includes(post.author._id) ? () => unlikePost() : () => likePost()} className={ post.likes.includes(post.author._id) ? 'flex gap-2 hover:bg-slate-200 cursor-pointer p-1 text-blue-500 font-bold' : 'flex gap-2 hover:bg-slate:200 cursor-pointer p-1' }>
                        <img src={ post.likes.includes(post.author._id) ? Liked : Like} alt="Like icon"/> Like
                    </div>
                    <div className='flex gap-2 hover:bg-slate-200 cursor-pointer p-1'>
                        <img src={CommentIcon} alt="Comment icon"/> Comment
                    </div>
