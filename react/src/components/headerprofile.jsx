                    ...
                    <div className="min-h-[75vh">
                        ...
                        <div className="flex flex-row justify-between p-6 border-b-2 z-1 relative">
                            <div className="flex flex-row items-center">
                                <img onClick={() => setAvatarEdit(true)} className="cursor-pointer rounded-full border-white min-h-[20vh] max-h-[20vh] bg-white absolute z-1 mb-20" src={userData.avatar} alt="User icon"></img>
