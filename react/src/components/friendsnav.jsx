...
const FriendsNav = () => {
    ...
    if (friendsRequest && !allFriends) {
        return (
            <div className="bg-white min-h-[91vh] max-h-[91vh] min-w-[25vw] max-w-[25vw] overflow-scroll shadow-xl">
    ...
    return (
        <div className="bg-white min-h-[91vh] max-h-[91vh] min-w-[25vw] max-w-[25vw] shadow-xl overflow-scroll">
